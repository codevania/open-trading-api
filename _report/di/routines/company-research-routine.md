...
7. Run [[scripts/di_private_input_status.py|di_private_input_status.py]] to confirm which private fields are still `missing` without printing the private values.
