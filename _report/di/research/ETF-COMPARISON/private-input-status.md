...
| ETF portfolio weight | 0 | 4 | 4 |
| ETF source meta | 4 | 0 | 4 |
| Satellite decision input | 0 | 48 | 48 |

## Field Status

| Area | Symbol | Field | Status | Safe next action |
| --- | --- | --- | --- | --- |
| ETF portfolio weight | `VOO` | `portfolio_etf_weights.VOO` | `missing` | fill private ETF portfolio percent, or 0 if deliberately not held |
...
| ETF portfolio weight | `VTI` | `portfolio_etf_weights.VTI` | `missing` | fill private ETF portfolio percent, or 0 if deliberately not held |
...
| ETF portfolio weight | `VT` | `portfolio_etf_weights.VT` | `missing` | fill private ETF portfolio percent, or 0 if deliberately not held |
...
| ETF portfolio weight | `QQQ` | `portfolio_etf_weights.QQQ` | `missing` | fill private ETF portfolio percent, or 0 if deliberately not held |
...
| Satellite decision input | `MSFT` | `inputs.MSFT.etf_overlap_checked` | `missing` | record core/satellite ETF overlap summary |
| Satellite decision input | `MSFT` | `inputs.MSFT.tax_account_route` | `missing` | record taxable, ISA, pension, or IRP route |
| Satellite decision input | `MSFT` | `inputs.MSFT.max_position_size` | `missing` | record maximum single-name weight |
| Satellite decision input | `MSFT` | `inputs.MSFT.add_trim_rule` | `missing` | record add, trim, and stop-adding rule |
...
| Satellite decision input | `GOOGL` | `inputs.GOOGL.etf_overlap_checked` | `missing` | record core/satellite ETF overlap summary |
| Satellite decision input | `GOOGL` | `inputs.GOOGL.tax_account_route` | `missing` | record taxable, ISA, pension, or IRP route |
| Satellite decision input | `GOOGL` | `inputs.GOOGL.max_position_size` | `missing` | record maximum single-name weight |
| Satellite decision input | `GOOGL` | `inputs.GOOGL.add_trim_rule` | `missing` | record add, trim, and stop-adding rule |
...
| Satellite decision input | `AMZN` | `inputs.AMZN.etf_overlap_checked` | `missing` | record core/satellite ETF overlap summary |
| Satellite decision input | `AMZN` | `inputs.AMZN.tax_account_route` | `missing` | record taxable, ISA, pension, or IRP route |
| Satellite decision input | `AMZN` | `inputs.AMZN.max_position_size` | `missing` | record maximum single-name weight |
| Satellite decision input | `AMZN` | `inputs.AMZN.add_trim_rule` | `missing` | record add, trim, and stop-adding rule |
...
| Satellite decision input | `META` | `inputs.META.etf_overlap_checked` | `missing` | record core/satellite ETF overlap summary |
| Satellite decision input | `META` | `inputs.META.tax_account_route` | `missing` | record taxable, ISA, pension, or IRP route |
| Satellite decision input | `META` | `inputs.META.max_position_size` | `missing` | record maximum single-name weight |
| Satellite decision input | `META` | `inputs.META.add_trim_rule` | `missing` | record add, trim, and stop-adding rule |
...
| Satellite decision input | `NVDA` | `inputs.NVDA.etf_overlap_checked` | `missing` | record core/satellite ETF overlap summary |
| Satellite decision input | `NVDA` | `inputs.NVDA.tax_account_route` | `missing` | record taxable, ISA, pension, or IRP route |
| Satellite decision input | `NVDA` | `inputs.NVDA.max_position_size` | `missing` | record maximum single-name weight |
| Satellite decision input | `NVDA` | `inputs.NVDA.add_trim_rule` | `missing` | record add, trim, and stop-adding rule |
...
| Satellite decision input | `AVGO` | `inputs.AVGO.etf_overlap_checked` | `missing` | record core/satellite ETF overlap summary |
| Satellite decision input | `AVGO` | `inputs.AVGO.tax_account_route` | `missing` | record taxable, ISA, pension, or IRP route |
| Satellite decision input | `AVGO` | `inputs.AVGO.max_position_size` | `missing` | record maximum single-name weight |
| Satellite decision input | `AVGO` | `inputs.AVGO.add_trim_rule` | `missing` | record add, trim, and stop-adding rule |
