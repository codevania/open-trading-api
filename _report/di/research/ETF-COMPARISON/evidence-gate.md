...
| `satellite_equities.primary_queue` | `NVDA` | NVIDIA | `hold` | `research valuation.md`, `research decision.md` | collect filings and write thesis/valuation/decision notes |
| `satellite_equities.primary_queue` | `AVGO` | Broadcom | `hold` | `research valuation.md`, `research decision.md` | collect filings and write thesis/valuation/decision notes |
