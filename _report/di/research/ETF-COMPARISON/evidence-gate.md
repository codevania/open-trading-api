...
| `satellite_equities.primary_queue` | `NVDA` | NVIDIA | `hold` | `research decision.md` | collect filings and write thesis/decision notes |
| `satellite_equities.primary_queue` | `AVGO` | Broadcom | `hold` | `research decision.md` | collect filings and write thesis/decision notes |
