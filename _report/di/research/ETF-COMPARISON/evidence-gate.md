...
| `satellite_equities.secondary_queue` | `AMD` | Advanced Micro Devices | `hold` | `research sec-filing-summary.md`, `research thesis.md`, `research decision.md` | collect filings and write thesis/decision notes |
