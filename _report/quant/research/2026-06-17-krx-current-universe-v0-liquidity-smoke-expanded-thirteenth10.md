...
- Machine-readable rows: [[_report/quant/research/2026-06-17-krx-current-universe-v0-liquidity-smoke-expanded-thirteenth10.rows.csv|_report/quant/research/2026-06-17-krx-current-universe-v0-liquidity-smoke-expanded-thirteenth10.rows.csv]]

## Summary

- Total rows: `2875`
- Base included rows before Liquidity Filter: `2390`
- Included rows after Liquidity Filter: `62`
- Excluded rows after Liquidity Filter: `2813`
- Rows with raw OHLCV evaluated: `132`
...
| `liquidity_raw_missing` | 2258 |
| `liquidity_value_below_threshold` | 70 |
