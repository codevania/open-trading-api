...
- Machine-readable rows: [[_report/quant/research/2026-06-17-krx-current-universe-v0-liquidity-smoke-expanded-tenth10.rows.csv|_report/quant/research/2026-06-17-krx-current-universe-v0-liquidity-smoke-expanded-tenth10.rows.csv]]

## Summary

- Total rows: `2875`
- Base included rows before Liquidity Filter: `2390`
- Included rows after Liquidity Filter: `53`
- Excluded rows after Liquidity Filter: `2822`
- Rows with raw OHLCV evaluated: `102`
...
| `liquidity_raw_missing` | 2288 |
| `liquidity_value_below_threshold` | 49 |
