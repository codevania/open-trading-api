...
- Machine-readable rows: [[_report/quant/research/2026-06-30-krx-current-universe-v0-liquidity-smoke-expanded-nineteenth10.rows.csv|_report/quant/research/2026-06-30-krx-current-universe-v0-liquidity-smoke-expanded-nineteenth10.rows.csv]]

## Summary

- Total rows: `2875`
- Base included rows before Liquidity Filter: `2390`
- Included rows after Liquidity Filter: `97`
- Excluded rows after Liquidity Filter: `2778`
- Rows with raw OHLCV evaluated: `192`
...
| `liquidity_raw_missing` | 2198 |
| `liquidity_value_below_threshold` | 95 |
