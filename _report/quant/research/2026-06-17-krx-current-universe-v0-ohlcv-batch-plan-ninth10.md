...
- Request queue JSONL: [[_report/quant/research/2026-06-17-krx-current-universe-v0-ohlcv-batch-plan-ninth10.requests.jsonl|_report/quant/research/2026-06-17-krx-current-universe-v0-ohlcv-batch-plan-ninth10.requests.jsonl]]
...
- Existing raw skipped: `80`
- Eligible after skip: `2310`
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | `001720` | 신영증권 | KOSPI | 20260301 | 20260615 | `001720.daily.raw.json` |
| 2 | `001740` | SK네트웍스 | KOSPI | 20260301 | 20260615 | `001740.daily.raw.json` |
| 3 | `001750` | 한양증권 | KOSPI | 20260301 | 20260615 | `001750.daily.raw.json` |
| 4 | `001770` | SHD | KOSPI | 20260301 | 20260615 | `001770.daily.raw.json` |
| 5 | `001780` | 알루코 | KOSPI | 20260301 | 20260615 | `001780.daily.raw.json` |
| 6 | `001790` | 대한제당 | KOSPI | 20260301 | 20260615 | `001790.daily.raw.json` |
| 7 | `001800` | 오리온홀딩스 | KOSPI | 20260301 | 20260615 | `001800.daily.raw.json` |
| 8 | `001810` | 무림SP | KOSDAQ | 20260301 | 20260615 | `001810.daily.raw.json` |
| 9 | `001820` | 삼화콘덴서 | KOSPI | 20260301 | 20260615 | `001820.daily.raw.json` |
| 10 | `001940` | KISCO홀딩스 | KOSPI | 20260301 | 20260615 | `001940.daily.raw.json` |
