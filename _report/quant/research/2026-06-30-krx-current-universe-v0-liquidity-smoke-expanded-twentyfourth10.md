...
- Machine-readable rows: [[_report/quant/research/2026-06-30-krx-current-universe-v0-liquidity-smoke-expanded-twentyfourth10.rows.csv|_report/quant/research/2026-06-30-krx-current-universe-v0-liquidity-smoke-expanded-twentyfourth10.rows.csv]]

## Summary

- Total rows: `2875`
- Base included rows before Liquidity Filter: `2390`
- Included rows after Liquidity Filter: `123`
- Excluded rows after Liquidity Filter: `2752`
- Rows with raw OHLCV evaluated: `242`
...
| `liquidity_raw_missing` | 2148 |
| `liquidity_value_below_threshold` | 119 |
