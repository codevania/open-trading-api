...
- Input: [[_report/quant/research/2026-07-08-kind-status-point-in-time-universe-smoke-merged-snapshots-20250102-20250321.rows.csv|_report/quant/research/2026-07-08-kind-status-point-in-time-universe-smoke-merged-snapshots-20250102-20250321.rows.csv]]
...
- Input rows: `142990`
- Dates: `52`
- Base `Point-in-Time Universe` include rows: `133465`
- Include rows after Liquidity Filter: `34408`
- Exclude rows after Liquidity Filter: `108582`
- Rows with full lookback evaluated: `84414`

## Liquidity Status Counts

| Status | Count |
| --- | ---: |
| `data_insufficient` | 49051 |
| `fail` | 50006 |
| `not_evaluated_preexisting_exclude` | 9525 |
| `pass` | 34408 |
...
| Reason | Count |
| --- | ---: |
| `liquidity_history_insufficient` | 49051 |
| `liquidity_value_below_threshold` | 50006 |
...
- This is still a smoke artifact because the current input covers only a bounded `52`-date window.
