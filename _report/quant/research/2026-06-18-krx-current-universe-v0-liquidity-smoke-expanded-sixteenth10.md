...
- Machine-readable rows: [[_report/quant/research/2026-06-18-krx-current-universe-v0-liquidity-smoke-expanded-sixteenth10.rows.csv|_report/quant/research/2026-06-18-krx-current-universe-v0-liquidity-smoke-expanded-sixteenth10.rows.csv]]

## Summary

- Total rows: `2875`
- Base included rows before Liquidity Filter: `2390`
- Included rows after Liquidity Filter: `80`
- Excluded rows after Liquidity Filter: `2795`
- Rows with raw OHLCV evaluated: `162`
...
| `liquidity_raw_missing` | 2228 |
| `liquidity_value_below_threshold` | 82 |
