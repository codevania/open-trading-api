...
- Request queue JSONL: [[_report/quant/research/2026-06-30-krx-current-universe-v0-ohlcv-batch-plan-twentyeighth10.requests.jsonl|_report/quant/research/2026-06-30-krx-current-universe-v0-ohlcv-batch-plan-twentyeighth10.requests.jsonl]]
...
- Existing raw skipped: `270`
- Eligible after skip: `2120`
...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | `006620` | 동구바이오제약 | KOSDAQ | 20260301 | 20260615 | `006620.daily.raw.json` |
| 2 | `006650` | 대한유화 | KOSPI | 20260301 | 20260615 | `006650.daily.raw.json` |
| 3 | `006660` | 삼성공조 | KOSPI | 20260301 | 20260615 | `006660.daily.raw.json` |
| 4 | `006730` | 서부T&D | KOSDAQ GLOBAL | 20260301 | 20260615 | `006730.daily.raw.json` |
| 5 | `006740` | 블루산업개발 | KOSPI | 20260301 | 20260615 | `006740.daily.raw.json` |
| 6 | `006800` | 미래에셋증권 | KOSPI | 20260301 | 20260615 | `006800.daily.raw.json` |
| 7 | `006840` | AK홀딩스 | KOSPI | 20260301 | 20260615 | `006840.daily.raw.json` |
| 8 | `006880` | 신송홀딩스 | KOSPI | 20260301 | 20260615 | `006880.daily.raw.json` |
| 9 | `006890` | 태경케미컬 | KOSPI | 20260301 | 20260615 | `006890.daily.raw.json` |
| 10 | `006910` | 보성파워텍 | KOSDAQ | 20260301 | 20260615 | `006910.daily.raw.json` |
