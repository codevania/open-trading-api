...
- Input: [[_report/quant/research/2026-07-09-kind-status-point-in-time-universe-smoke-merged-3snapshots-20250102-20250418.rows.csv|_report/quant/research/2026-07-09-kind-status-point-in-time-universe-smoke-merged-3snapshots-20250102-20250418.rows.csv]]
...
- Machine-readable rows: [[_report/quant/research/2026-07-09-kind-status-point-in-time-liquidity-smoke-merged-3snapshots-20d-20250102-20250418.rows.csv|_report/quant/research/2026-07-09-kind-status-point-in-time-liquidity-smoke-merged-3snapshots-20d-20250102-20250418.rows.csv]]

## Summary

- Input rows: `198137`
- Dates: `72`
- Base `Point-in-Time Universe` include rows: `184549`
- Include rows after Liquidity Filter: `54138`
- Exclude rows after Liquidity Filter: `143999`
- Rows with full lookback evaluated: `135316`

## Liquidity Status Counts

| Status | Count |
| --- | ---: |
| `data_insufficient` | 49233 |
| `fail` | 81178 |
| `not_evaluated_preexisting_exclude` | 13588 |
| `pass` | 54138 |
...
| Reason | Count |
| --- | ---: |
| `liquidity_history_insufficient` | 49233 |
| `liquidity_value_below_threshold` | 81178 |
...
- This is still a smoke artifact because the current input covers only a bounded `72`-date window.
