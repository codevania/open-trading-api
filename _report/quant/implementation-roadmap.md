...
| 4. Point-in-Time Universe | in-progress | 80-83% | KRX OpenAPI market-data path works; three KIND current snapshots are merged into `634` logical status-event rows across `3` raw capture dates, 81-date local market enrichment leaves `61` `UNKNOWN` market rows across `31` codes, a 72-date `Point-in-Time Universe` smoke still produced `184549` include / `13588` exclude rows, and status coverage audit keeps this at `hold` because the source is still `current_snapshot_smoke` with `0` release/resume-like events and no filled source coverage manifest; lifecycle gap report identifies `314` code/status groups that need release/resume evidence, the evidence collection plan prioritizes `385` pending rows (`10` manifest raw evidence, `314` release/resume evidence, `61` market-label evidence), the local queue condenses them into `33` plan-only batches, the P1 source-manifest fill packet maps the `10` P1 batches to exact blank fields to fill, the fill-progress report shows `0/10` materializable rows, and the local materializer now refuses blank/pending fill packets | Capture official raw evidence for `P1-*`, fill `source_url` / `raw_path` / `confidence`, materialize and validate the source manifest, then execute `P2-*` and `P3-*` evidence batches before Universe eligibility promotion |
...
| 8. OOS / Walk-Forward | preflight | 18-22% | [[scripts/quant_oos_walk_forward_preflight.py|scripts/quant_oos_walk_forward_preflight.py]] segments attribution smoke into deterministic temporal folds as `pass_smoke_plumbing_only`, while OOS readiness remains `hold` | Run production OOS only after Point-in-Time coverage, actual costs, and Backtest engine gates pass |
| 9. Bias Control pass | preflight | 25-30% | [[scripts/quant_bias_control_preflight.py|scripts/quant_bias_control_preflight.py]] reads readiness/OOS/status/strategy-bias evidence and keeps Bias Control status at `hold` with machine-readable blocker rows | Resolve Point-in-Time, actual costs, production OOS, and live-control blockers before any Bias Control pass |
| 10. Paper Signal tracking | partial | 78-82% | 72-date, 20-day Point-in-Time Liquidity rows now feed `2120` paper-only Momentum `Signal Candidate` rows, complete `1,5` trading-day forward-return coverage using prices through `2025-05-02`, long-only portfolio target, Backtest input contract, PnL smoke, and attribution smoke outputs | Keep candidates signal-only until production Point-in-Time coverage, Backtest, OOS, and Bias Control pass |
...
- [[_report/quant/research/2026-07-09-point-in-time-status-evidence-collection-plan-20250102-20250418-market-enriched-81d|_report/quant/research/2026-07-09-point-in-time-status-evidence-collection-plan-20250102-20250418-market-enriched-81d.md]]
- [[_report/quant/research/2026-07-09-point-in-time-status-evidence-collection-plan-20250102-20250418-market-enriched-81d.rows.csv|_report/quant/research/2026-07-09-point-in-time-status-evidence-collection-plan-20250102-20250418-market-enriched-81d.rows.csv]]
...
- Evidence collection queue: [[scripts/quant_point_in_time_status_evidence_collection_queue.py|scripts/quant_point_in_time_status_evidence_collection_queue.py]] converts that plan into [[_report/quant/research/2026-07-10-point-in-time-status-evidence-collection-queue-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-evidence-collection-queue-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-evidence-collection-queue-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-evidence-collection-queue-merged-3snapshots-market-enriched-81d.rows.csv]], grouping `385` source plan rows into `33` plan-only batches: `P1-*` source manifest evidence, `P2-*` release/resume evidence, and `P3-*` UNKNOWN market-label resolution. This is not source coverage evidence and keeps Backtest readiness at `hold`.
- Evidence collection checklist: [[scripts/quant_point_in_time_status_evidence_collection_checklist.py|scripts/quant_point_in_time_status_evidence_collection_checklist.py]] renders the full queue into [[_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d.md]], with `33` pending operator batches, `385` queued source rows, and `347` queued code references across `P1`, `P2`, and `P3`. This is an instruction artifact only, not source coverage evidence.
- Source manifest fill packet: [[scripts/quant_point_in_time_status_source_manifest_fill_packet.py|scripts/quant_point_in_time_status_source_manifest_fill_packet.py]] converts only the `P1-*` queue rows into [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]], producing `10` fill rows with `source_url_hint` and `raw_path_suggestion` capture aids while `source_url_to_fill`, `raw_path_to_fill`, and `confidence_to_fill` stay blank until official raw capture. This is a fill checklist only, not source coverage evidence.
- P1 official capture checklist: [[scripts/quant_point_in_time_status_capture_checklist.py|scripts/quant_point_in_time_status_capture_checklist.py]] renders [[_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d.md]], grouping the same `10` P1 rows into an operator checklist with `10` pending rows and `0` ready rows. This is an instruction artifact only, not source coverage evidence.
- Source manifest fill progress: [[scripts/quant_point_in_time_status_source_manifest_fill_progress.py|scripts/quant_point_in_time_status_source_manifest_fill_progress.py]] reports current fill completeness without materializing or validating coverage; [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]] show `0/10` materializable rows and `10/10` missing `source_url_to_fill`, `raw_path_to_fill`, `confidence_to_fill`, and non-pending `evidence_capture_status`.
- Source manifest materializer: [[scripts/quant_point_in_time_status_source_manifest_materialize.py|scripts/quant_point_in_time_status_source_manifest_materialize.py]] converts a filled packet into the source coverage manifest CSV shape only after `source_url_to_fill`, `raw_path_to_fill`, `confidence_to_fill`, and non-pending `evidence_capture_status` are present. It intentionally rejects the current blank P1 packet, so it cannot promote a checklist into coverage evidence.
...
- [[scripts/quant_oos_walk_forward_preflight.py|scripts/quant_oos_walk_forward_preflight.py]]
- [[tests/test_quant_oos_walk_forward_preflight.py|tests/test_quant_oos_walk_forward_preflight.py]]
- [[_report/quant/research/2026-07-09-oos-walk-forward-preflight-20d-20250102-20250418-price-through-20250502|_report/quant/research/2026-07-09-oos-walk-forward-preflight-20d-20250102-20250418-price-through-20250502.md]]
- [[_report/quant/research/2026-07-09-oos-walk-forward-preflight-20d-20250102-20250418-price-through-20250502.folds.csv|_report/quant/research/2026-07-09-oos-walk-forward-preflight-20d-20250102-20250418-price-through-20250502.folds.csv]]
- Result: `3` deterministic temporal fold rows over the attribution smoke window, `OOS/WF preflight status=pass_smoke_plumbing_only`, average test baseline net return `-0.0827%`, and average test baseline active return `0.0466%`.
- Limitation: this is fold plumbing only. It inherits current `Point-in-Time` status coverage gaps and assumption-only costs, so OOS readiness stays `hold`.

Bias Control preflight:

- [[scripts/quant_bias_control_preflight.py|scripts/quant_bias_control_preflight.py]]
- [[tests/test_quant_bias_control_preflight.py|tests/test_quant_bias_control_preflight.py]]
- [[_report/quant/research/2026-07-09-bias-control-preflight-20d-20250102-20250418-price-through-20250502|_report/quant/research/2026-07-09-bias-control-preflight-20d-20250102-20250418-price-through-20250502.md]]
- [[_report/quant/research/2026-07-09-bias-control-preflight-20d-20250102-20250418-price-through-20250502.rows.csv|_report/quant/research/2026-07-09-bias-control-preflight-20d-20250102-20250418-price-through-20250502.rows.csv]]
- Result: `10` Bias Control checks, status counts `blocked=2`, `hold=5`, `pass_smoke=2`, and `pass_smoke_plumbing_only=1`; final Bias Control status remains `hold`.
- Limitation: this is a preflight summary only. `Point-in-Time` coverage, actual KIS fee override, production OOS, and live-control gates still block Bias Control pass.
...
- Latest readiness with evidence queue: [[_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-evidence-queue|_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-evidence-queue.md]]
- Latest evidence collection checklist: [[_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d.md]]
- Latest P1 source-manifest fill packet: [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.md]]
- Latest P1 official capture checklist: [[_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d.md]]
- Latest P1 operator guide for manual KRX/KIND capture: [[_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-operator-guide|_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-operator-guide.md]]
- Latest P1 source-manifest fill progress: [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.md]]
- Latest readiness with source-manifest fill progress: [[_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress|_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress.md]]
- Result: market-data window `pass`, Liquidity Filter `pass_smoke`, Signal Candidate `pass_smoke`, forward-return smoke `pass_smoke` with complete `1,5` horizon coverage, portfolio target smoke `pass_smoke`, Backtest input contract `pass_smoke`, Backtest PnL smoke `pass_smoke`, Backtest assumptions `pass_assumption_only`, benchmark returns smoke `pass_smoke`, Backtest attribution smoke `pass_smoke_assumption_only`, OOS/Walk-Forward preflight `pass_smoke_plumbing_only`, Bias Control preflight `hold`, Point-in-Time status evidence collection plan `plan_only` with `385` pending evidence rows, Point-in-Time status evidence collection queue `plan_only` with `33` batches, Point-in-Time status source manifest fill packet `plan_only` with `10` rows, Point-in-Time status source manifest fill progress `blocked` with `0/10` materializable rows, Point-in-Time status coverage `hold` with merged 3-snapshot coverage audit evidence including source manifest validation `not_supplied` and lifecycle missing release/resume groups `314`, Backtest engine `hold`, live trading controls `blocked`, KIS demo account `blocked`.
...
- Point-in-Time evidence collection plan/queue/full checklist/fill packet/P1 capture checklist/progress/materializer: latest 3-snapshot local plan organizes `385` pending evidence rows (`10` manifest raw evidence, `314` release/resume evidence, `61` market-label evidence), the local queue groups them into `33` plan-only batches (`P1=10`, `P2=18`, `P3=5`), the full evidence checklist renders those batches as `33` pending operator tasks, the P1 fill packet maps the `10` source-manifest batches to fill fields plus non-evidence `source_url_hint` and `raw_path_suggestion` capture aids, the P1 capture checklist renders those same rows as `10` pending operator tasks, the fill-progress report shows `0/10` materializable rows, and the materializer refuses blank/pending rows until official raw capture exists. These are collection targets only and do not count as source coverage.
- Quant readiness check: latest 20-day price-through smoke gate report using the market-enriched 3-snapshot status coverage audit, lifecycle gap report, evidence collection plan/queue, source-manifest fill packet/progress, Backtest attribution smoke, OOS/WF preflight, and Bias Control preflight marks market-data window `pass`, Liquidity Filter, Signal Candidate, forward-return, portfolio targets, Backtest input contract, Backtest PnL smoke, and benchmark returns as `pass_smoke`, Backtest assumptions as `pass_assumption_only`, Backtest attribution smoke as `pass_smoke_assumption_only`, OOS/Walk-Forward preflight as `pass_smoke_plumbing_only`, Bias Control preflight as `hold`, Point-in-Time status evidence collection plan as `plan_only`, Point-in-Time status evidence collection queue as `plan_only`, Point-in-Time status source manifest fill packet as `plan_only`, Point-in-Time status source manifest fill progress as `blocked`, Point-in-Time status coverage `hold` with lifecycle missing release/resume groups `314`, Backtest engine `hold`, live trading controls `blocked`, and KIS demo account `blocked`.
