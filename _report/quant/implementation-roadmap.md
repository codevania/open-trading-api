...
- Source manifest fill packet: [[scripts/quant_point_in_time_status_source_manifest_fill_packet.py|scripts/quant_point_in_time_status_source_manifest_fill_packet.py]] converts only the `P1-*` queue rows into [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]], producing `10` fill rows with `source_url_to_fill`, `raw_path_to_fill`, and `confidence_to_fill` still blank until official raw capture. This is a fill checklist only, not source coverage evidence.
