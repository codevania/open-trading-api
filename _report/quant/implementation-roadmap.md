...
- Source manifest draft validation: [[_report/quant/research/2026-07-09-point-in-time-status-source-manifest-draft-validate-20250102-20250418-market-enriched-81d|_report/quant/research/2026-07-09-point-in-time-status-source-manifest-draft-validate-20250102-20250418-market-enriched-81d.md]] records `10/10` row failures because every draft row still lacks `source_url`, `raw_path`, and `confidence`.
