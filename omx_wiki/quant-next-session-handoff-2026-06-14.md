...
3. Resolve remaining `47` `UNKNOWN` KIND market rows only where an official source or deterministic join beyond the current market-data enrichment can support it.
