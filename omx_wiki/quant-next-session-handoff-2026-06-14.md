...
- Point-in-Time full evidence collection checklist generation is implemented; [[scripts/quant_point_in_time_status_evidence_collection_checklist.py|scripts/quant_point_in_time_status_evidence_collection_checklist.py]] writes [[_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d.md]], showing `33` pending operator batches, `385` queued source rows, and `347` queued code references across `P1`, `P2`, and `P3`. This is an instruction artifact only, not source coverage evidence.
- Point-in-Time source manifest fill packet generation is implemented; [[scripts/quant_point_in_time_status_source_manifest_fill_packet.py|scripts/quant_point_in_time_status_source_manifest_fill_packet.py]] writes [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]], mapping the `10` P1 batches to blank evidence fields plus `source_url_hint` and `raw_path_suggestion` capture aids. The evidence fields must be filled only after official raw capture. This is a fill checklist only, not source coverage evidence.
- Point-in-Time P1 official capture checklist generation is implemented; [[scripts/quant_point_in_time_status_capture_checklist.py|scripts/quant_point_in_time_status_capture_checklist.py]] writes [[_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d.md]], showing `10` pending operator capture rows and `0` ready rows. This is an instruction artifact only, not source coverage evidence.
- Point-in-Time source manifest fill-progress reporting is implemented; [[scripts/quant_point_in_time_status_source_manifest_fill_progress.py|scripts/quant_point_in_time_status_source_manifest_fill_progress.py]] writes [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]], showing `0/10` materializable P1 rows and `10/10` rows missing official capture fields. This is progress tracking only, not source coverage evidence.
- Point-in-Time source manifest materialization is implemented; [[scripts/quant_point_in_time_status_source_manifest_materialize.py|scripts/quant_point_in_time_status_source_manifest_materialize.py]] converts filled P1 packet rows into source coverage manifest rows only when capture fields are non-blank and non-pending. The current blank fill packet fails materialization by design.
...
- Quant readiness check is implemented; the latest 20-day local report [[_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress|_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress.md]] with merged 3-snapshot status coverage, lifecycle gap evidence, evidence collection plan/queue, source-manifest fill packet/progress, attribution smoke, OOS/WF preflight, and Bias Control preflight marks market-data window `pass`, Liquidity Filter `pass_smoke`, Signal Candidate `pass_smoke`, forward-return smoke `pass_smoke`, portfolio target smoke `pass_smoke`, Backtest input contract `pass_smoke`, Backtest PnL smoke `pass_smoke`, Backtest assumptions `pass_assumption_only`, benchmark returns smoke `pass_smoke`, Backtest attribution smoke `pass_smoke_assumption_only`, OOS/Walk-Forward preflight `pass_smoke_plumbing_only`, Bias Control preflight `hold`, Point-in-Time status evidence collection plan `plan_only` with `385` pending rows, evidence collection queue `plan_only` with `33` batches, source-manifest fill packet `plan_only` with `10` rows, source-manifest fill progress `blocked` with `0/10` materializable rows, Point-in-Time status coverage `hold` with source manifest validation `not_supplied` and lifecycle missing release/resume groups `314` (`managed_issue=106`, `market_alert=78`, `trading_halt=130`), Backtest engine `hold`, live trading controls `blocked`, and KIS demo account `blocked`.
...
2. Use the full evidence checklist [[_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d.md]], the P1 capture checklist [[_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d.md]], the P1 fill packet rows from [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]], and track progress with [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] while capturing official raw KRX/KIND evidence. Use `source_url_hint` and `raw_path_suggestion` only as capture aids, then fill `source_url_to_fill`, `raw_path_to_fill`, `confidence_to_fill`, and non-pending `evidence_capture_status` until `materializable_rows == fill_packet_rows`. Then run [[scripts/quant_point_in_time_status_source_manifest_materialize.py|scripts/quant_point_in_time_status_source_manifest_materialize.py]] followed by [[scripts/quant_point_in_time_status_source_manifest_validate.py|scripts/quant_point_in_time_status_source_manifest_validate.py]] and the coverage audit; after that, use the remaining evidence collection queue rows from [[_report/quant/research/2026-07-10-point-in-time-status-evidence-collection-queue-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-evidence-collection-queue-merged-3snapshots-market-enriched-81d.rows.csv]] to obtain historical status transition coverage across the selected rebalance range. Extra current snapshots help evidence preservation but do not solve release/resume lifetimes by themselves.
...
17. Re-run [[scripts/quant_readiness_check.py|scripts/quant_readiness_check.py]] after each Point-in-Time, evidence collection plan/queue, fill-packet/fill-progress, Liquidity Filter, Signal Candidate, forward-return, portfolio-target, Backtest contract, PnL smoke, assumption, benchmark, attribution, OOS/WF preflight, Bias Control preflight, or KIS account milestone.
...
- Latest readiness check [[_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress|_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress.md]] confirms the same state: evidence collection plan `plan_only`, evidence collection queue `plan_only`, source-manifest fill packet `plan_only`, source-manifest fill progress `blocked`, Point-in-Time status coverage `hold`, Backtest `hold`, live trading `blocked`; the fill-progress gate confirms `0/10` P1 rows are materializable.
