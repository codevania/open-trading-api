...
- Point-in-Time source manifest draft generation is implemented; [[_report/quant/research/2026-07-09-point-in-time-status-source-manifest-draft-20250102-20250418-market-enriched-81d|_report/quant/research/2026-07-09-point-in-time-status-source-manifest-draft-20250102-20250418-market-enriched-81d.md]] records `10` `pending_raw_evidence` draft rows across `managed_issue`, `trading_halt`, `market_alert`, and `delisting`. The draft intentionally leaves `source_url`, `raw_path`, and `confidence` blank until official raw files are captured.
