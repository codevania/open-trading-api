...
This repository wiki captures durable project knowledge that should survive Codex session changes.

## Quant

- [[quant-implementation-status-2026-06-14]] - Current Quant implementation state, 62-date KRX OpenAPI smoke baseline, merged KIND status coverage audit, blockers, and next gates.
