...
- The latest Backtest PnL smoke is `pass_smoke` with `860` rows, `840` complete rows, and `20` missing forward prices on the latest Signal Candidate date.
