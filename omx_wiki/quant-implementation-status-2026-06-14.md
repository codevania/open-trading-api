...
- KIND current snapshot status events replayed against the 42-date KRX OpenAPI market-data merge and marked `705/115447` rows as `exclude_by_status_event`.
