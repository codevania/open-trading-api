...
- [[scripts/quant_point_in_time_status_evidence_collection_checklist.py|scripts/quant_point_in_time_status_evidence_collection_checklist.py]] renders the full evidence queue into an operator checklist without KIS/KRX calls or order intents; [[_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-evidence-collection-checklist-merged-3snapshots-market-enriched-81d.md]] shows `33` pending batches, `385` queued source rows, and `347` queued code references across `P1`, `P2`, and `P3`. This is an instruction artifact only, not source coverage evidence.
- [[scripts/quant_point_in_time_status_source_manifest_fill_packet.py|scripts/quant_point_in_time_status_source_manifest_fill_packet.py]] converts the `P1-*` queue rows into an official-source capture fill packet without KIS/KRX calls or order intents; [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-packet-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]] record `10` fill rows with `source_url_hint` and `raw_path_suggestion` capture aids while `source_url_to_fill`, `raw_path_to_fill`, and `confidence_to_fill` remain blank until official raw capture. This is a fill checklist only, not source coverage evidence.
- [[scripts/quant_point_in_time_status_capture_checklist.py|scripts/quant_point_in_time_status_capture_checklist.py]] renders the P1 fill packet into an operator checklist without KIS/KRX calls, validation, materialization, or order intents; [[_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-11-point-in-time-status-p1-official-capture-checklist-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] shows `10` checklist rows, `10` pending rows, and `0` ready rows. This is an instruction artifact only, not source coverage evidence.
- [[scripts/quant_point_in_time_status_source_manifest_fill_progress.py|scripts/quant_point_in_time_status_source_manifest_fill_progress.py]] summarizes P1 fill completeness without KIS/KRX calls, order intents, materialization, or coverage validation; [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.md]] and [[_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-10-point-in-time-status-source-manifest-fill-progress-20250102-20250418-merged-3snapshots-market-enriched-81d.rows.csv]] show `0/10` materializable rows and `10/10` rows missing official capture fields.
...
- [[scripts/quant_readiness_check.py|scripts/quant_readiness_check.py]] summarizes local Quant gates without calling KIS/KRX or generating order intents and links the local status coverage audit, lifecycle gap report, evidence collection plan/queue, source-manifest fill packet, and source-manifest fill progress into the Point-in-Time status gates, including source manifest validation and missing release/resume group counts when present. The fill-progress gate tracks evidence-entry completeness only and does not promote readiness.
...
- [[_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress|_report/quant/research/2026-07-10-quant-readiness-check-merged-3snapshots-20d-20250102-20250418-price-through-20250502-with-source-manifest-fill-progress.md]] records the latest readiness gate state with the queue included as `point_in_time_status_evidence_collection_queue=plan_only`, the P1 fill packet included as `point_in_time_status_source_manifest_fill_packet=plan_only`, and fill progress included as `point_in_time_status_source_manifest_fill_progress=blocked`; Backtest readiness remains `hold` and live trading remains `blocked`. The latest fill-progress artifact confirms `0/10` P1 rows are materializable, so this is still a manual official-evidence collection lane.
...
- Tests for manifest verification, managed issue extraction, current Universe build, OHLCV batch planning, KRX OpenAPI collection/history collection/normalization/history planning/continuity auditing/market-data joining/market-data merging, KRX Data Marketplace status-source probing, KIND status probing/extraction, status-event validation/replay/enrichment/merge/unknown-market targeting/coverage auditing/lifecycle gap reporting/evidence collection planning/evidence collection queueing/full evidence checklist/source-manifest fill packet/P1 capture checklist/fill progress/materialization, Point-in-Time Universe smoke, Point-in-Time Liquidity Filter smoke, Point-in-Time Momentum Signal Candidate smoke, Signal forward-return smoke, portfolio target smoke, Backtest input contract validation, Backtest PnL smoke, Backtest assumptions validation, benchmark return smoke, Backtest attribution smoke, OOS/Walk-Forward preflight, Bias Control preflight, Quant readiness checking with fill-progress gate, KIS demo order/account preflight, Liquidity Filter, and calendar audit pass.
