...
- The two-snapshot merged status-event set has `497` logical event rows. The original merged file had `48` `UNKNOWN` market rows; [[_report/quant/research/2026-07-09-kind-status-events-merged-market-enrich-81d|_report/quant/research/2026-07-09-kind-status-events-merged-market-enrich-81d.md]] uses the 81-date local market-data merge to resolve `1` additional market label, leaving `47` `UNKNOWN` rows. [[_report/quant/research/2026-07-09-kind-status-events-unknown-market-targets-market-enriched-81d|_report/quant/research/2026-07-09-kind-status-events-unknown-market-targets-market-enriched-81d.md]] narrows those rows to `31` codes split across `trading_halt=28`, `delisting=9`, `managed_issue=6`, and `market_alert=4`. The latest 72-date replay marked `1646/198137` rows as `exclude_by_status_event`.
...
- [[_report/quant/research/2026-07-08-kind-status-events-merge-20260703-20260708|_report/quant/research/2026-07-08-kind-status-events-merge-20260703-20260708.md]] records the merged two-snapshot evidence: `671` input rows, `497` output rows, `174` merged duplicates, and `2` raw capture dates.
- [[_report/quant/research/2026-07-08-kind-status-events-merged-20260703-20260708-validation|_report/quant/research/2026-07-08-kind-status-events-merged-20260703-20260708-validation.md]] validates the merged events as `497/497` valid with `0` duplicate event keys.
...
- [[_report/quant/research/2026-07-09-point-in-time-status-coverage-audit-20250102-20250418-merged-snapshots-market-enriched-81d|_report/quant/research/2026-07-09-point-in-time-status-coverage-audit-20250102-20250418-merged-snapshots-market-enriched-81d.md]] records coverage status `hold`: mode `current_snapshot_smoke`, replay matched `198137/198137` rows, rows with any status-event code `18320`, rows with applied status event `1646`, rows excluded by status event `1646`, raw status capture dates `2`, release/resume-like event rows `0`, source coverage manifest rows `0`, source coverage manifest validation `not_supplied`, and row failures `0`. Lifecycle diagnostics show `managed_issue` `105/0`, `market_alert` `75/0`, and `trading_halt` `253/0` active-like/release-resume rows.
- [[scripts/quant_point_in_time_status_lifecycle_gap_report.py|scripts/quant_point_in_time_status_lifecycle_gap_report.py]] turns the aggregate lifecycle gap into code/status collection targets. [[_report/quant/research/2026-07-09-point-in-time-status-lifecycle-gaps-20250102-20250418-merged-snapshots-market-enriched-81d|_report/quant/research/2026-07-09-point-in-time-status-lifecycle-gaps-20250102-20250418-merged-snapshots-market-enriched-81d.md]] records `304` lifecycle groups with `missing_release_resume_evidence`: `managed_issue=104`, `market_alert=70`, and `trading_halt=130`; [[_report/quant/research/2026-07-09-point-in-time-status-lifecycle-gaps-20250102-20250418-merged-snapshots-market-enriched-81d.rows.csv|_report/quant/research/2026-07-09-point-in-time-status-lifecycle-gaps-20250102-20250418-merged-snapshots-market-enriched-81d.rows.csv]] stores the machine-readable collection target rows.
- [[scripts/quant_point_in_time_status_evidence_collection_plan.py|scripts/quant_point_in_time_status_evidence_collection_plan.py]] consolidates the source manifest draft, lifecycle gap rows, and unknown-market targets without KRX/KIS calls; [[_report/quant/research/2026-07-09-point-in-time-status-evidence-collection-plan-20250102-20250418-market-enriched-81d|_report/quant/research/2026-07-09-point-in-time-status-evidence-collection-plan-20250102-20250418-market-enriched-81d.md]] records `361` collection rows split into `source_manifest_evidence=10`, `release_resume_evidence=304`, and `market_label_resolution=47`. This is a plan only, not source coverage evidence.
...
- [[_report/quant/research/2026-07-09-backtest-attribution-smoke-20d-20250102-20250418-price-through-20250502|_report/quant/research/2026-07-09-backtest-attribution-smoke-20d-20250102-20250418-price-through-20250502.md]] records `53` date-horizon rows as `pass_smoke_assumption_only`: average gross return `0.3758%`, average baseline net return `0.0458%`, average stress net return `-0.3242%`, average baseline active return `0.0280%`, and `broker_fee_override_required=true`.
...
- [[_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-market-enriched-81d-status|_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-market-enriched-81d-status.md]] records the previous gate state before attribution smoke wiring: market-data window `pass`, Liquidity Filter `pass_smoke`, Signal Candidate `pass_smoke`, forward-return smoke `pass_smoke`, portfolio target smoke `pass_smoke`, Backtest input contract `pass_smoke`, Backtest PnL smoke `pass_smoke`, Backtest assumptions `pass_assumption_only`, benchmark returns smoke `pass_smoke`, Point-in-Time status coverage `hold` with source manifest validation `not_supplied` and lifecycle missing release/resume groups `304` (`managed_issue=104`, `market_alert=70`, `trading_halt=130`), Backtest engine `hold`, live trading controls `blocked`, and KIS demo account `blocked`.
- [[_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-attribution-smoke|_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-attribution-smoke.md]] adds `backtest_attribution_smoke=pass_smoke_assumption_only` to the latest gate state while keeping `Point-in-Time status coverage=hold`, `Backtest engine=hold`, `live_trading_controls=blocked`, and `kis_demo_account=blocked`.
- [[_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-oos-preflight|_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-oos-preflight.md]] adds `oos_walk_forward_preflight=pass_smoke_plumbing_only` to the latest gate state while keeping `Point-in-Time status coverage=hold`, `Backtest engine=hold`, `live_trading_controls=blocked`, and `kis_demo_account=blocked`.
- [[_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-bias-preflight|_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-bias-preflight.md]] adds `bias_control_preflight=hold` to the latest gate state while keeping `Point-in-Time status coverage=hold`, `Backtest engine=hold`, `live_trading_controls=blocked`, and `kis_demo_account=blocked`.
- [[_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-evidence-plan|_report/quant/research/2026-07-09-quant-readiness-check-20d-20250102-20250418-price-through-20250502-evidence-plan.md]] adds `point_in_time_status_evidence_collection_plan=plan_only` with `361` pending evidence rows while keeping `Point-in-Time status coverage=hold`, `Backtest engine=hold`, `live_trading_controls=blocked`, and `kis_demo_account=blocked`.
...
4. Extend KIND or authenticated/manual KRX status coverage across the selected historical date range, resolve the remaining `47` merged `UNKNOWN` KIND market rows where supported, produce the source coverage manifest, let [[scripts/quant_point_in_time_status_coverage_audit.py|scripts/quant_point_in_time_status_coverage_audit.py]] validate it through [[scripts/quant_point_in_time_status_source_manifest_validate.py|scripts/quant_point_in_time_status_source_manifest_validate.py]], validate/replay the expanded event rows, and rebuild [[scripts/quant_point_in_time_universe_build.py|scripts/quant_point_in_time_universe_build.py]] output.
