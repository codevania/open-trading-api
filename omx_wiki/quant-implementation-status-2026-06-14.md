...
8. Generate paper/smoke `Signal Candidate` outputs from `Point-in-Time Universe` plus Liquidity Filter rows.
...
11. Only then run Backtest/OOS/Walk-Forward and Bias Control pass.
