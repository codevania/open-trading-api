...
- The latest Signal forward-return smoke produced `4240` horizon rows across `1,5` trading-day horizons: `4000` complete and `240` missing forward prices.
...
- The latest Backtest PnL smoke is `pass_smoke` with `1060` rows, `1040` complete rows, `1040` KOSPI benchmark joined rows, `20` missing forward prices on the latest Signal Candidate date, and average weighted excess vs benchmark of `0.0171%`.
...
- [[_report/quant/research/2026-07-08-benchmark-return-smoke-20d-20250102-20250418|_report/quant/research/2026-07-08-benchmark-return-smoke-20d-20250102-20250418.md]] records `318` benchmark horizon rows for KOSPI, KOSDAQ, and KOSPI200: `300` complete and `18` `missing_forward_index`.
- [[_report/quant/research/2026-07-08-benchmark-return-smoke-20d-20250102-20250418.rows.csv|_report/quant/research/2026-07-08-benchmark-return-smoke-20d-20250102-20250418.rows.csv]] stores the machine-readable benchmark return smoke rows.
...
- [[_report/quant/research/2026-07-08-signal-forward-return-smoke-20d-20250102-20250418|_report/quant/research/2026-07-08-signal-forward-return-smoke-20d-20250102-20250418.md]] records `4240` horizon rows across `1,5` trading-day horizons: `4000` complete and `240` missing forward prices because the smoke window still ends too soon.
